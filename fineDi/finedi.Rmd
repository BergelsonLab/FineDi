...
```{r seen}
seen <- matrix(c(0,1,2,3, 237, 450, 488, 625), ncol=4, byrow = TRUE)
colnames(seen) <- c("","","", "")
rownames(seen) <- c("N", "Number of clips scored by N persons")
seen
```

## Histogram of segment length by language

The clips were chosen among CHN segments longer than 500ms.
